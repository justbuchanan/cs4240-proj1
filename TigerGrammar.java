...
public class TigerGrammar extends Grammar {
	TigerGrammar() {
		...
		addRule(new ProductionRule(NonTerminals.STAT_PRIME, new ParserSymbol[]{
		...
		//OPT_PREFIX
		addRule(new ProductionRule(NonTerminals.OPT_PREFIX, new ParserSymbol[]{
		...
		addRule(new ProductionRule(NonTerminals.MULT_DIV_EXPR_TAIL, new ParserSymbol[]{
				new Token(State.MULT), new NonTerminalParserSymbol(NonTerminals.NEGATED_EXPR), 
		...
		addRule(new ProductionRule(NonTerminals.ADD_SUB_EXPR_TAIL, new ParserSymbol[]{
				new Token(State.PLUS), new NonTerminalParserSymbol(NonTerminals.MULT_DIV_EXPR),
		...
		addRule(new ProductionRule(NonTerminals.AND_EXPR_TAIL, new ParserSymbol[]{
				new Token(State.AND), new NonTerminalParserSymbol(NonTerminals.BOOL_EXPR), 
		...
		addRule(new ProductionRule(NonTerminals.EXPR_LIST_TAIL, new ParserSymbol[]{
			new Token(State.COMMA), new NonTerminalParserSymbol(NonTerminals.EXPR), 
		...
		addRule(new ProductionRule(NonTerminals.LVALUE, new ParserSymbol[]{
				new Token(State.ID), new NonTerminalParserSymbol(NonTerminals.LVALUE_TAIL)
		}));
		
		// LVALUE_TAIL
		addRule(new ProductionRule(NonTerminals.LVALUE_TAIL, new ParserSymbol[]{
			new Token(State.LBRACK), new NonTerminalParserSymbol(NonTerminals.EXPR), 
			new Token(State.RBRACK), new NonTerminalParserSymbol(NonTerminals.LVALUE_TAIL)
		}));
